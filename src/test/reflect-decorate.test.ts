...
describe('Reflect.decorate', () => {
  it('ThrowsIfDecoratorsArgumentNotArrayForFunctionOverload', () => {
    let target = function() {}
    expect(() =>
      Reflect.decorate(undefined, target, undefined, undefined)
    ).toThrow(TypeError)
  })
  ...
  it('ThrowsIfDecoratorsArgumentNotArrayForPropertyOverload', () => {
    let target = {}
    let name = 'name'
    expect(() => Reflect.decorate(undefined, target, name, undefined)).toThrow(
      TypeError
    )
  })
  ...
  it('ThrowsIfTargetArgumentNotObjectForPropertyOverload', () => {
    ...
    let target = 1
    let name = 'name'
    expect(() => Reflect.decorate(decorators, target, name, undefined)).toThrow(
      TypeError
    )
  })
  ...
  it('ThrowsIfDecoratorsArgumentNotArrayForPropertyDescriptorOverload', () => {
    ...
    let name = 'name'
    let descriptor = {}
    expect(() => Reflect.decorate(undefined, target, name, descriptor)).toThrow(
      TypeError
    )
  })
